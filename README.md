...
### Для лінивих
Відкрий CloudFormation та згодуй йому відповідний [сніп](https://slovotvir.org.ua/words/fail). Май на увазі, що деякі речі все одно доведеться робити руками, а конкретно під'єднувати ALB до лямби і [волок](https://slovotvir.org.ua/words/trafik) - до ALB за допомогою гукала (alias).

![Route53](info/r53.png)
